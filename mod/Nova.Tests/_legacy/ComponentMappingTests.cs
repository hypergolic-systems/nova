...
public class ComponentMappingTests {
  ...
  // Battery save/load tests removed — Battery is Rust-owned now.
  // Proto fields (BatteryStructure, BatteryState) stay; persistence
  // tests come back when Rust-side save/load lands.
