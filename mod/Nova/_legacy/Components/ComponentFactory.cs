...
public static class ComponentFactory {
  ...
  // NovaBatteryModule + NovaCommandModule are handled by the Rust
  // simulator (nova-ksp) — NovaVesselModule scans for them directly
  // and pushes them into the FFI World, bypassing this factory.
  // Also-deleted: NovaFuelCellModule, NovaSolarModule,
  // NovaDeployableSolarModule (Phase-1 verification crafts must
  // avoid these until they're FFI-ported in a later PR).
